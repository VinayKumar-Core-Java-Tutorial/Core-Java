package _7_4.Arrays_Programs;//Write a Java program to find all the unique triplets such that 
//sum of all the three elements  equal to a specified number.
