package _7_4.Arrays_Programs;//Write a Java program to create an array of its anti-diagonals from a given square matrix.
import java.util.*;
public class Program_38 {
	 public static ArrayList<ArrayList<Integer>> Program_38(ArrayList<ArrayList<Integer>> A) {
