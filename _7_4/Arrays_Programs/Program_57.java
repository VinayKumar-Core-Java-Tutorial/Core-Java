package _7_4.Arrays_Programs;//Java Program to Find Union & Intersection of 2 Arrays
...
public class Program_57 {
	    ...
	    static void displayProgram_57(int[] arrayOne,int[] arrayTwo){
	...
	public static void main(String[] args) {
        ...
        displayProgram_57(arrayOne,arrayTwo);
	}
